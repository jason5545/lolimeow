...
$options[] = array(
    'name' => __('開源授權條款', 'ui_boxmoe_com'), 
    'id' => 'banquan',
    'desc' => __('
     <p>1.主題依託於開源授權條款 GPL V3.0，如果不接受本協議，請立即刪除</p>
     <p>2.請遵循開源授權條款，保留主題底部版權資訊，如果不接受本協議，請立即刪除；</p>		
    ', 'ui_boxmoe_com'),
    'type' => 'info');
$options[] = array(
    ...
    'id' => 'shiyong',
    'desc' => __('
     <p>1.主題僅供部落格愛好者合法建站交流！禁止使用於違法用途！如如主題使用者不能遵守此規定，請立即刪除；</p>
     <p>2.嚴禁利用本主題嚴重侵犯他人隱私權，如主題使用者不能遵守此規定，請立即刪除；</p>
     <p>3.使用主題請遵守網站伺服器當地相關法律和站長當地相關法律，如不能遵守請立即刪除；</p>
     <p>4.主題不支持任何作為非法違規用途站點！如不能遵守請立即刪除；</p>
     <p>5.主題開源無任何加密檔案，對於因用戶使用本主題而造成自身或他人隱私洩露，等任何不良後果，均由用戶自行承擔，主題作者不負任何責任；</p>
...
$options[] = array(
    'name' => __('網站已運行時間', 'ui_boxmoe_com'),
    'id' => 'boxmoe_footer_runtime',
    'type' => 'checkbox',
    'std' => true,
    'desc' => __('若開啟則底部顯示網站已運行時間', 'ui_boxmoe_com'),
);
$options[] = array(
    'group' => 'end',
    ...
    'type' => 'text',
    'std' => '11/11/2018',
    'desc' => __('開啟網站已運行時間後，網站運行時間的開始時間，格式：月/日/年', 'ui_boxmoe_com'),
);
$options[] = array(
    'group' => 'start',
    'group_title' => '首頁設定',
