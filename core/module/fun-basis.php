          ...
          <div class="col-md-4">
            <div class="d-flex align-items-center justify-content-center justify-content-md-end" id="social-links">
              <div class="text-center text-md-end">
                <?php if(get_boxmoe('boxmoe_social_facebook')): ?>
                <a href="<?php echo get_boxmoe('boxmoe_social_facebook'); ?>" class="text-reset btn btn-social btn-facebook" target="_blank">
                ...
                <?php endif; ?>
                <?php if(get_boxmoe('boxmoe_social_twitter')): ?>
                <a href="<?php echo get_boxmoe('boxmoe_social_twitter'); ?>" class="text-reset btn btn-social btn-twitter" target="_blank">
                ...
                <a href="mailto:<?php echo get_boxmoe('boxmoe_social_email'); ?>" class="text-reset btn btn-social btn-email" target="_blank">
...
function boxmoe_nav_menu(){
    ...
    if (has_nav_menu('boxmoe-menu')) {
        ...
        echo '<div class="navbar-nav mx-auto align-items-lg-center"></div>';
    }
}
