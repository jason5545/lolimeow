    ...
    <div class="floating-action-menu">
      <nav class="floating-menu-items">
        <ul>
          ...
          <li class="d-lg-none">
            <button class="float-btn" title="開啟側欄" data-bs-toggle="offcanvas" href="#blog-sidebar" aria-controls="blog-sidebar">
          ...
          <li>
            <a id="lolijump" href="#" title="返回頂部">
              <img src="<?php echo boxmoe_theme_url(); ?>/assets/images/top/<?php echo get_boxmoe('boxmoe_lolijump_img'); ?>.gif" alt="返回頂部"></a>
          </li>
          <?php endif; ?>
        </ul>
      </nav>
