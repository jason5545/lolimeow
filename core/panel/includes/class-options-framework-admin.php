	 ...
	 function options_page() { ?><?php $menu = $this->menu_settings(); ?>
	  ...
	  <?php settings_errors( 'options-framework' ); ?> 
		<div class="set-main-plane">
			...
			<span class="dashicons dashicons-nametag"></span> 盒子萌主題     <svg width="24" height="24" viewBox="0 0 24 24">
		...
		<i class="cx cx-begin"></i> 線上文件 | <span id="dbox"></span></a>
		</div>			
		...
		<div id="optionsframework-submit">
			...
			<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '重設所有設定', 'textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '警告：點擊確定，之前所有設定修改都將遺失！', 'textdomain' ) ); ?>' );" />
			<div class="clear"></div>
		</div>		
					</form>
		</div> 
...
boxmoe_version();
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( '已還原預設選項!', 'textdomain' ), 'updated fade' );
