		...
		QTags.addButton( 'userreading1', '会员檢視模式一', '[userreading]', '隐藏内容[/userreading]','','userreading1' );  
		QTags.addButton( 'userreading2', '会员檢視模式二', '[userreading notice="未登录时候显示的内容"]', '隐藏内容[/userreading]','','userreading2' ); 
