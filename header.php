...
<head>
  ...
  <?php
    ...
    $banner_url = '';
    if (function_exists('get_boxmoe')) {
        $banner_url = get_boxmoe('banner_url');
    }
    if ($banner_url) :
  ?>
    <link rel="preload" as="image" href="<?php echo esc_url($banner_url); ?>">
  <?php endif; ?>

  <!-- 於此處載入 Noto Sans TC 字體 -->
  <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC&display=swap" rel="stylesheet" media="print" onload="this.media='all'">
  <noscript><link href="https://fonts.googleapis.com/css2?family=Noto+Sans+TC&display=swap" rel="stylesheet"></noscript>
  <style>
    body {
...
<body>
  <?php if (get_boxmoe('boxmoe_preloader')) { ?>
    <div class="preloader">
      <svg version="1.1" id="boxmoe-sakura" xmlns="http://www.w3.org/2000/svg"
        ...
        <g id="sakura">
          ...
          <animateTransform attributeType="XML" attributeName="transform" type="rotate"
                           values="0 40 40; 360 40 40" calcMode="linear" dur="10s" repeatCount="indefinite">
          </animateTransform>
        </g>
        ...
        <animateTransform attributeName="transform" type="scale" additive="sum" keyTimes="0;0.5;1"
                          keySplines="0.42 0.0 0.58 1.0" values="1,1;0.75,0.75;1,1" dur="3s" repeatCount="indefinite">
        </animateTransform>
        <animateTransform attributeName="transform" type="translate" additive="sum" from="-40,-40" to="-40,-40">
        </animateTransform>
      </svg>
    </div>
  <?php } ?>
      ...
      <nav class="navbar navbar-expand-lg navbar-bg-box">
        <div class="container">
          ...
          <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1"
               id="navigation" aria-labelledby="offcanvasWithBothOptionsLabel">
                      ...
                      <div class="user-wrapper">
                        <div class="user-no-login">
                          <span class="user-login">
                            ...
                            <b class="middle-text">
                              <span class="middle-inner">或</span>
                            </b>
                          </span>
                          <span class="user-reg">
                            <a href="<?php echo wp_registration_url(); ?>" class="signup-loader l-bor">註冊</a>
                          </span>
                        </div>
                        <i class="up-new"></i>
                      </div>
                    ...
                    <li class="nav-item dropdown dropdown-hover nav-item">
                      <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true"
                        ...
                        <?php
                          ...
                          echo '您好，' . esc_html($current_user->user_login);
                        ?>
                      </a>
                      <ul class="dropdown-menu">
                        <li>
                          <a href="<?php echo get_edit_user_link(); ?>" class="dropdown-item">
                            <i class="fa fa-address-card-o"></i> 會員中心
                          </a>
                        </li>
                        <li>
