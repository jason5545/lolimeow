...
<html <?php language_attributes(); ?>>
    ...
    <!-- Open Graph protocol for better social sharing -->
    <meta property="og:locale" content="<?php echo get_locale(); ?>" />
    <meta property="og:type" content="<?php echo (is_single() || is_page()) ? 'article' : 'website'; ?>" />
    <meta property="og:title" content="<?php echo boxmoe_theme_title(); ?>" />
    <meta property="og:description" content="<?php echo boxmoe_seo_description(); ?>" />
    ...
    <meta name="twitter:title" content="<?php echo boxmoe_theme_title(); ?>">
    <meta name="twitter:description" content="<?php echo boxmoe_seo_description(); ?>">
    <?php if(is_single() && has_post_thumbnail()): ?>
             ...
             <?php boxmoe_nav_menu();?>
              <div class="nav-right-section d-flex align-items-center">
                ...
                <button
                    ...
                    <span class="visually-hidden bs-theme-text">主題顏色切換</span>
                </button>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <a class="dropdown-item" href="<?php echo boxmoe_user_center_link_page(); ?>">
                          <i class="fa fa-user-circle"></i>會員中心</a>
                      </li>
                      <?php if(current_user_can('administrator')): ?>
                      <li>
                        <a class="dropdown-item" target="_blank" href="<?php echo admin_url(); ?>">
                          <i class="fa fa-cog"></i>後台管理</a>
                      </li>
                      <?php endif; ?>
                      <li>
